...
This function estimates the microbial relative abundance in stool (mixture), rectum (reference) and other gastrointestinal (GI) locations. For example:
